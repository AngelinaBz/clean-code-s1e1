...
var incompleteTaskHolder=document.querySelector(".tasks__list_todo");//ul of todo section
var completedTasksHolder=document.querySelector(".tasks__list_completed");//completed section
...
var addTask=function(){
  ...
  //Create a new list item with the text from the tasks__input_add:
